...
export const FAQ_DETAILS_CS: Record<string, FaqDetailCs> = {
  'what-is-skinify': {
    ...
    body: [
      ...
      { type: 'p', text: 'Skinport účtuje prodejcům 12 % — šestkrát víc než my. Obě platformy používají escrow a platí v reálných penězích, ale rozdíl v poplatcích znamená, že na Skinify si z každého prodeje necháte víc. Máme také nativní podporu českých bank přes Stripe, zatímco Skinport směruje platby přes SEPA.' },
      { type: 'h', text: 'Kdo Skinify provozuje' },
      { type: 'p', text: 'Skinify s.r.o. — registrovaná česká společnost s ručením omezeným (IČO 29671311) se sídlem na adrese Grafická 3365/1, 150 00 Praha 5. Platby zpracovává Stripe, licencovaná evropská platební instituce. Všechny transakce jsou daňově doložené a firemním zákazníkům vystavujeme faktury s DPH.' },
    ],
  ...
  'what-are-the-fees': {
    ...
    body: [
      ...
      { type: 'p', text: 'Při vkladu prostředků může Stripe (náš platební procesor) účtovat malé procento podle metody — obvykle 1–2 % u karet, 0 % u českých bankovních převodů, ~3 % u paysafecard. Tyto poplatky se zobrazí před potvrzením vkladu.' },
      ...
      { type: 'ul', items: [
        ...
        'Vrácení na kartu (vzácné, u nevyužitých vkladů): dle pravidel Stripe',
      ]},
  ...
  'is-skinify-safe': {
    ...
    answer:
      'Ano. Každý obchod je chráněn escrowem po dobu 8 dnů. Skinify s.r.o. je registrovaná česká firma, platby zpracovává Stripe (licencovaná EU platební instituce).',
    body: [
      ...
      { type: 'p', text: 'Platby zpracovává Stripe, licencovaná platební instituce regulovaná právem EU. Údaje o kartě se nikdy nedostanou na servery Skinify — putují přímo z vašeho prohlížeče do tokenizačního API Stripe. Nikdy nevidíme vaše CVV, celé číslo karty ani bankovní údaje.' },
  ...
  'how-to-withdraw-money': {
    ...
    body: [
      ...
      { type: 'h', text: 'Poplatky za výběr' },
      { type: 'p', text: 'Výběry na české banky jsou zdarma. SEPA mezinárodní: zdarma pod 10 000 Kč, paušálně 50 Kč nad. Vrácení na kartu: dle poplatků Stripe (obvykle 0 u vrácení na původní kartu).' },
