...
/* SteamCompareChip — links straight to the item's Steam Community Market
   listing page so the buyer can compare prices there. The URL is
   /market/listings/730/<market_hash_name>; Steam resolves the encoded
   name to the listing. */
const SteamCompareChip: React.FC<{ marketHashName: string }> = ({ marketHashName }) => (
  <a
    ...
    className="h-10 px-3 rounded-full text-[12px] font-bold text-ink-muted hover:text-ink transition-colors inline-flex items-center gap-1.5"
  >
    <BarChart3 size={15} strokeWidth={2.2} />
    <span className="hidden sm:inline">Compare Steam price</span>
  </a>
);
