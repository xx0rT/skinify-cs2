  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="bg-purple-600 hover:bg-purple-500 px-4 py-2 rounded-lg text-white transition-all">
          Export Users
        </button>
      </div>
            ...
            <tbody>
              {filteredUsers.map((user) => (
                <tr key={user.id} className="border-b border-gray-700/50 hover:bg-gray-700/30 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-300 font-mono text-sm">{user.steam_id}</td>
                  <td className="py-3 px-4">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center space-x-2">
                      <div className="text-white font-medium">{user.reputation_score}</div>
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center justify-end space-x-2">
                      <button className="text-blue-400 hover:text-blue-300 p-2 rounded-lg hover:bg-blue-500/10 transition-all">
                        <Mail size={16} />
                      </button>
                      <button className="text-yellow-400 hover:text-yellow-300 p-2 rounded-lg hover:bg-yellow-500/10 transition-all">
